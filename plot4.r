...
with(subp,{
  plot(subp$time,as.numeric(as.character(subp$GAP)),type="l",xlab="",ylab="Global Active Power")
  plot(subp$time,as.numeric(as.character(subp$Vol)), type="l",xlab="datetime",ylab="Voltage")
  ...
  plot(subp$time,as.numeric(as.character(subp$GRP)),type="l",xlab="datetime",ylab="Global_reactive_power")
})
dev.off()